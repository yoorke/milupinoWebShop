function legend(parent, data, unit) {
    legend(parent, data, unit, null);
}

function legend(parent, data, unit, chart, legendTemplate) {
	legendTemplate = typeof legendTemplate !== 'undefined' ? legendTemplate : "<%=label%> <%=value%> <%=unit%>";
    ...
    datas.forEach(function(d, i) {
        ...
        legendNode = legendNode.replace("<%=unit%>", unit);
